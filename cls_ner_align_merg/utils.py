...
def clean(params):
    ...
    # 'params:<tensorflow.python.platform.flags._FlagValues object at 0x7f9b51db57b8>'
    # print("vocab_file:{}".format(params.vocab_file))
    # print("map_file:{}".format(params.map_file))
    # print("ckpt_path:{}".format(params.ckpt_path))
    # print("summary_path:{}".format(params.summary_path))
    # print("result_path:{}".format(params.result_path))
    # print("config_file:{}".format(params.config_file))
...
def create_model(session, Model_class, path, load_vec, config, id_to_char, logger):
    ...
    # "Model_class:<class 'model.Model'>"
    # print("config:{}".format(config))
    # "config:OrderedDict([('num_chars', 1103), ('char_dim', 100), ('num_tags', 34), ('seg_dim', 20), ('lstm_dim', 100), ('batch_size', 20), ('emb_file', 'wiki_100.utf8'), ('clip', 5), ('dropout_keep', 0.5), ('optimizer', 'adam'), ('lr', 0.001), ('tag_schema', 'iobes'), ('pre_emb', False), ('zeros', False), ('lower', False)])"
    ...
    if ckpt and tf.train.checkpoint_exists(ckpt.model_checkpoint_path):
        ...
        # print("pre_emb:{}".format(config["pre_emb"]))
        # pre_emb: False
        if config["pre_emb"]:
